view: dwb_flow_at_mobile_app_event_i_d_20201218 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_mobile_app_event_i_d_20201218`
    ;;
...
view: dwb_flow_at_mobile_app_event_i_d_20201218__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_mobile_app_event_i_d_20201218__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
