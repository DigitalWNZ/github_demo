view: dwb_flow_at_mobile_app_event_i_d_20200923 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_mobile_app_event_i_d_20200923`
    ;;
...
view: dwb_flow_at_mobile_app_event_i_d_20200923__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_mobile_app_event_i_d_20200923__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
