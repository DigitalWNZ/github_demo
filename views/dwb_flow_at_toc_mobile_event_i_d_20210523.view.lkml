view: dwb_flow_at_toc_mobile_event_i_d_20210523 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_toc_mobile_event_i_d_20210523`
    ;;
...
view: dwb_flow_at_toc_mobile_event_i_d_20210523__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_toc_mobile_event_i_d_20210523__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
