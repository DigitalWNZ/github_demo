view: dwb_flow_at_toc_mobile_event_i_d_20210511 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_toc_mobile_event_i_d_20210511`
    ;;
...
view: dwb_flow_at_toc_mobile_event_i_d_20210511__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_toc_mobile_event_i_d_20210511__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
