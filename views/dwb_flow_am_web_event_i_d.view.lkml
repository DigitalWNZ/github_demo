view: dwb_flow_am_web_event_i_d {
  sql_table_name: `dwb_utc_00.dwb_flow_am_web_event_i_d`
    ;;
...
view: dwb_flow_am_web_event_i_d__items {
...
view: dwb_flow_am_web_event_i_d__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_am_web_event_i_d__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_am_web_event_i_d__page__page_event_params {
