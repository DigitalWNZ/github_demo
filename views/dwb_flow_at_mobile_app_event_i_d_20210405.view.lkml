view: dwb_flow_at_mobile_app_event_i_d_20210405 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_mobile_app_event_i_d_20210405`
    ;;
...
view: dwb_flow_at_mobile_app_event_i_d_20210405__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_mobile_app_event_i_d_20210405__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
