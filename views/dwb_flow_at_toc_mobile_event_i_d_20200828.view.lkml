view: dwb_flow_at_toc_mobile_event_i_d_20200828 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_toc_mobile_event_i_d_20200828`
    ;;
...
view: dwb_flow_at_toc_mobile_event_i_d_20200828__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_toc_mobile_event_i_d_20200828__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
