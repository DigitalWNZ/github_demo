view: dwb_flow_at_toc_mobile_event_i_d_20210317 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_toc_mobile_event_i_d_20210317`
    ;;
...
view: dwb_flow_at_toc_mobile_event_i_d_20210317__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_toc_mobile_event_i_d_20210317__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
