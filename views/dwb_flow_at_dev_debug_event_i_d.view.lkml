view: dwb_flow_at_dev_debug_event_i_d {
  sql_table_name: `dwb_utc_00.dwb_flow_at_dev_debug_event_i_d`
    ;;
...
view: dwb_flow_at_dev_debug_event_i_d__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_dev_debug_event_i_d__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
