view: dwb_flow_at_mobile_app_event_i_d_20201110 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_mobile_app_event_i_d_20201110`
    ;;
...
view: dwb_flow_at_mobile_app_event_i_d_20201110__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_mobile_app_event_i_d_20201110__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
