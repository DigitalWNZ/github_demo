view: dwb_flow_at_mobile_app_event_i_d_20200712 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_mobile_app_event_i_d_20200712`
    ;;
...
view: dwb_flow_at_mobile_app_event_i_d_20200712__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_mobile_app_event_i_d_20200712__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
