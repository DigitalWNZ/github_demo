view: dwb_flow_at_toc_mobile_event_i_d_20210128 {
  sql_table_name: `dwb_utc_00.dwb_flow_at_toc_mobile_event_i_d_20210128`
    ;;
...
view: dwb_flow_at_toc_mobile_event_i_d_20210128__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: dwb_flow_at_toc_mobile_event_i_d_20210128__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
